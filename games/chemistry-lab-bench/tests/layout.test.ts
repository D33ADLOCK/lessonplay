...
describe("computeStationLayout", () => {
  ...
  it("reproduces the renderer's original beaker geometry", () => {
    // Guards the fluid layer: these are the exact numbers the Canvas used
    // before the glass moved to SVG. A row of three, first column.
